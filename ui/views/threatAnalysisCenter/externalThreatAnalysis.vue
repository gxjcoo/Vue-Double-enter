  ...
  <div>
    ...
    <el-collapse-transition>
      <div v-show="show" class="transition-box">
        <div class="box1">
        <div class="box-item">
          <Card cardTitle="外部发起方地理分布" borderRadius="10px 0 0 10px">
            <div id="charts1" style=" width:100%;height:100%;"></div>
          </Card>
        </div>
        <div class="box-item">
          <Card cardTitle="TOP受害方" borderRadius="0 10px 0 0">
            <div id="charts2" style=" width:100%;height:100%;"></div>
          </Card>
          <Card cardTitle="受害方被攻击趋势" borderRadius="0 0 10px  0">
...
export default {
  data() {
    return {
        ...
        title2:'外部威胁汇总',
        titleEn2:'External Threat Summary',
      show: true,
      show2: true,
      tableData: [
        {
